<div>
    ...
    @if(count($pay) > 0)
        ...
        @foreach($pay as $payData)
            <div class="row col-lg-12 mt-5 text-center">
                <div class="col-lg-6">
                    {{$payData["pa_nombre"]}}
                </div>
                <div class="col-lg-6">
                    <a href="{{route("administrarPagosEditar",[$payData["pa_id"]])}}" class="btn btn-info">
                    ...
                    <button class="btn btn-danger mr-2" onclick="deleteConfirm({{$payData["pa_id"]}})"
                            style="color: #1b1e21">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
    ...
    <div class="row col-lg-12 text-center mt-5">
        ...
        <div class="col-lg-6">
            <button class="btn btn-success mr-2" wire:click="redirectCreatePayMethod" style="color: #1b1e21">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
