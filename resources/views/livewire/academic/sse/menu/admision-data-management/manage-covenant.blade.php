<div>
    ...
    @if(count($coven) > 0)
        ...
        @foreach($coven as $covenData)
            <div class="row col-lg-12 mt-5 text-center">
                <div class="col-lg-6">
                    {{$covenData["con_nombre"]}}
                </div>
                <div class="col-lg-6">
                    <a href="{{route("administrarConveniosEditar",[$covenData["con_id"]])}}" class="btn btn-info">
                    ...
                    {{--                    wire:click="deleteData({{$covenData["con_id"]}})"--}}
                    <button class="btn btn-danger mr-2" onclick="deleteConfirm({{$covenData["con_id"]}})" style="color: #1b1e21">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
    ...
    <div class="row col-lg-12 text-center mt-5">
        ...
        <div class="col-lg-6">
            <button class="btn btn-success mr-2" wire:click="redirectCreateCovenant" style="color: #1b1e21">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
