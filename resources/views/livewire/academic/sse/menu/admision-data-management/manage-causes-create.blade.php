<div>
    <div class="row col-lg-12 justify-content-center mt-5 text-center">
        <h5><b>Gestion Causas Crear</b></h5>
    </div>
    ...
    <div class="col-lg-12 mt-4 d-flex justify-content-center">
        ...
        <button class="btn btn-info mr-2" wire:click="insertCause">
        ...
        <a class="btn btn-danger" href="{{route("administrarDatosAtencion")}}">
    ...
    <div class="col-lg-12 d-flex justify-content-center ">
        @if (session()->has('causeSaved'))
            <div class="alert alert-success">
                {{ session('causeSaved') }}
            </div>
        @endif
        @if (session()->has('causeSavedFailed'))
            <div class="alert alert-danger">
                {{ session('causeSavedFailed') }}
            </div>
        @endif
    </div>
