<div>
    <div class="row col-lg-12 justify-content-center mt-5 text-center">
        <h5><b>Gestión Tipo Formulario Crear</b></h5>
    </div>
    ...
    <div class="row col-lg-12 justify-content-center mt-0 text-center">
        <input type="text" wire:model="nameToSave" value="" placeholder="digite">
    </div>
    <div class="col-lg-12 mt-4 d-flex justify-content-center">

        <button class="btn btn-info mr-2" wire:click="insert">
        ...
        <a class="btn btn-danger" href="{{route("administrarTipoFormulario")}}">
    ...
    <div class="col-lg-12 d-flex justify-content-center ">
        @if (session()->has('typeSaved'))
            <div class="alert alert-success">
                {{ session('typeSaved') }}
            </div>
        @endif
        @if (session()->has('typeSavedFailed'))
            <div class="alert alert-danger">
                {{ session('typeSavedFailed') }}
            </div>
        @endif
    </div>
