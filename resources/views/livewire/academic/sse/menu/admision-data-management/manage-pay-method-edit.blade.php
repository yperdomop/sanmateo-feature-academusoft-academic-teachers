<div>
    <div class="row col-lg-12 justify-content-center mt-5 text-center">
        <h5><b>Gestión Pagos Editar</b></h5>
    </div>
    ...
    <div class="col-lg-12 mt-4 d-flex justify-content-center">
        ...
        <a class="btn btn-danger" href="{{route("administrarPagos")}}">
    ...
    <div class="col-lg-12 d-flex justify-content-center ">
        @if (session()->has('paySaved'))
            <div class="alert alert-success">
                {{ session('paySaved') }}
            </div>
        @endif
        @if (session()->has('paySavedFailed'))
            <div class="alert alert-danger">
                {{ session('paySavedFailed') }}
            </div>
        @endif
    </div>
