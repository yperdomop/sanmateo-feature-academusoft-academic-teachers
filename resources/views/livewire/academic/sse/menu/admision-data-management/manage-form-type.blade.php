<div>
    <div class="row col-lg-12 justify-content-center mt-5 text-center">
        <h5><b>Gestion Tipos de Formulario</b></h5>
    </div>
    ...
    @if(count($form) > 0)
        ...
        @foreach($form as $data)
            <div class="row col-lg-12 mt-5 text-center">
                ...
                <div class="col-lg-6">
                    <a href="{{route("administrarTipoFormularioEditar",[$data["tf_id"]])}}" class="btn btn-info">
                    ...
                    <button class="btn btn-danger mr-2" onclick="deleteConfirm({{$data["tf_id"]}})"
                            style="color: #1b1e21">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
